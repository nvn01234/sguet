            ...
            <div class="col-lg-9">
                <div class="tabbable-line bg-white bordered">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="#edit_mode" data-toggle="tab" aria-expanded="false"> Sửa </a>
                        </li>
                        <li>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="edit_mode">
                        <div class="bg-white bordered form">
                            {{Form::model($article, ['method' => 'post', 'class' => 'form-horizontal', 'route' => ['manage.article.update', $article->id], 'id' => 'edit-article-form'])}}
                            <div class="form-body">
                                <div class="alert alert-info">
                                    <strong>Lưu ý:</strong> Các thay đổi chỉ thực sự được lưu khi bấm <a
                                            href="javascript:" class="alert-link" id="submit-link">Cập nhật</a>.
                                </div>
                    ...
                    <div class="tab-pane fade" id="preview_mode">
                        <div class="blog-single-content bordered blog-container">
                            ...
                            <div class="blog-single-img" @if(!$article->image_url) style="display: none" @endif>
