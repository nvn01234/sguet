...
@section('page-breadcrumb')
    ...
    <li>
        <a href="{{route('manage.links')}}">{{$link->url}}</a>
        <i class="fa fa-angle-right"></i>
    </li>
    <li>
        <span>Sửa link</span>
...
@section('page-body')
    <div class="portlet light">
        <div class="portlet-body form">
            {!! Form::model($link, ['method' => 'post', 'role' => 'form', 'class' => 'form-horizontal', 'route' => ['manage.links.update', $link->id]]) !!}
            <div class="form-body">
