...
@section('page-title', $contact->getNameWithDescription())
...
@section('page-body')
    <div class="portlet light">
        <div class="portlet-body form">
            {!! Form::model($contact, ['method' => 'post', 'role' => 'form', 'class' => 'form-horizontal', 'route' => ['manage.contact.update', $contact->id]]) !!}
            <div class="form-body">
